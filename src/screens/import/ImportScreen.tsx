...
export function ImportScreen({
  ...
  return (
    // `screen--fill` + `screen-scroll`: la cabecera se queda fija y solo
    // scrollea el contenido, igual que en las otras cinco pantallas. Antes
    // usaba `.screen` a secas, así que al encoger la ventana se iba el título
    // hacia arriba y scrolleaba la pantalla ENTERA.
